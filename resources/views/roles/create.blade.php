                ...
                <div class="col-12 col-lg-5 p-0 main-box">
                    <div class="col-12 px-0">
                        <div class="col-12 px-3 py-3">
                            <span class="fas fa-info-circle" style="color: #3a3b45">Add New</span>
                        </div>
                    ...
                    <div class="col-12 p-3 row">
                        ...
                        <div class="col-12 col-lg-6 p-2">
                            <div class="col-12" style="color: #3a3b45">
                                Role Name
                            </div>
                            <div class="col-12 pt-3">
                                <input style="color: #3a3b45" type="text" name="name" required maxlength="190" class="form-control" value="{{old('name',$role??"")}}">
                            </div>
                        </div>
                    ...
                    <div class="col-12 p-2">
                        <table class="table table-hover">
                            <thead>
                            <tr style="">
                                <th style="color: #3a3b45">Permission</th>
                                <th style="width: 56px;color: #3a3b45">Create</th>
                                <th style="width: 56px;color: #3a3b45">View</th>
                                <th style="width: 56px;color: #3a3b45">Update</th>
                                <th style="width: 56px;color: #3a3b45">Delete</th>
                            </tr>
                            </thead>
                            <tbody>
